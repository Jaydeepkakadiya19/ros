...
class SetElevatorActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new SetElevatorFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SetElevatorFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SetElevatorActionFeedback(null);
    ...
    data.feedback = SetElevatorFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SetElevatorFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetElevatorActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = SetElevatorFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new SetElevatorFeedback()
    }
...
module.exports = SetElevatorActionFeedback;
