...
class SetElevatorActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new SetElevatorResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SetElevatorResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SetElevatorResult.getMessageSize(object.result);
    return length;
  }
  ...
  static md5sum() {
    ...
    return '6ee26b6df4f4d156c6b8e7c62865c546';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetElevatorActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = SetElevatorResult.Resolve(msg.result)
    }
    else {
      resolved.result = new SetElevatorResult()
    }
...
module.exports = SetElevatorActionResult;
