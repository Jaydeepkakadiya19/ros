...
(cl:defmethod cl:initialize-instance :after ((m <State>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'State)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robospect_msgs-msg:<State> is deprecated: use robospect_msgs-msg:State instead.")))
...
(cl:defmethod desired_freq-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robospect_msgs-msg:desired_freq-val is deprecated.  Use robospect_msgs-msg:desired_freq instead.")
  (desired_freq m))

(cl:ensure-generic-function 'real_freq-val :lambda-list '(m))
(cl:defmethod real_freq-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robospect_msgs-msg:real_freq-val is deprecated.  Use robospect_msgs-msg:real_freq instead.")
  (real_freq m))

(cl:ensure-generic-function 'state_description-val :lambda-list '(m))
(cl:defmethod state_description-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robospect_msgs-msg:state_description-val is deprecated.  Use robospect_msgs-msg:state_description instead.")
  (state_description m))

(cl:ensure-generic-function 'control_mode-val :lambda-list '(m))
(cl:defmethod control_mode-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robospect_msgs-msg:control_mode-val is deprecated.  Use robospect_msgs-msg:control_mode instead.")
  (control_mode m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<State>)))
  ...
  "robospect_msgs/State")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'State)))
  "Returns string type for a message object of type 'State"
  "robospect_msgs/State")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<State>)))
  "Returns md5sum for a message object of type '<State>"
  "dfca35ea56f7d6866bf502504f711dc8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'State)))
  "Returns md5sum for a message object of type 'State"
  "dfca35ea56f7d6866bf502504f711dc8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<State>)))
  "Returns full string definition for message of type '<State>"
  (cl:format cl:nil "# constants~%int32 INIT_STATE = 100~%int32 STANDBY_STATE = 200~%int32 READY_STATE = 300~%int32 EMERGENCY_STATE = 400~%int32 FAILURE_STATE = 500~%int32 SHUTDOWN_STATE = 600~%int32 UNKNOWN_STATE = 700~%int32 MANUAL_STATE = 800~%int32 SPECIAL_STATE = 900~%int32 CHARGE_STATE = 1000~%int32 PARKING_STATE = 1100~%~%# state of the component~%int32 state~%# desired control loop frecuency~%float32 desired_freq~%# real frecuency ~%float32 real_freq~%# Description of the state~%string state_description~%# Control mode (POSITION, VELOCITY)~%string control_mode~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'State)))
  "Returns full string definition for message of type 'State"
  (cl:format cl:nil "# constants~%int32 INIT_STATE = 100~%int32 STANDBY_STATE = 200~%int32 READY_STATE = 300~%int32 EMERGENCY_STATE = 400~%int32 FAILURE_STATE = 500~%int32 SHUTDOWN_STATE = 600~%int32 UNKNOWN_STATE = 700~%int32 MANUAL_STATE = 800~%int32 SPECIAL_STATE = 900~%int32 CHARGE_STATE = 1000~%int32 PARKING_STATE = 1100~%~%# state of the component~%int32 state~%# desired control loop frecuency~%float32 desired_freq~%# real frecuency ~%float32 real_freq~%# Description of the state~%string state_description~%# Control mode (POSITION, VELOCITY)~%string control_mode~%~%~%"))
