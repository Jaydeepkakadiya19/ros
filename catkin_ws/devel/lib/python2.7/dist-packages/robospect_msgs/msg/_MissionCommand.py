...
"""autogenerated by genpy from robospect_msgs/MissionCommand.msg. Do not edit."""
import sys
...
class MissionCommand(genpy.Message):
  _md5sum = "ff86b621d1d6dd071a2101fe0b67f6fa"
  _type = "robospect_msgs/MissionCommand"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# System mission command (from GCS to IGC)
string command
...
float64 z
"""
  __slots__ = ['command','variable','points']
  _slot_types = ['string','float32','robospect_msgs/MissionPoint[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MissionCommand, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_f().pack(self.variable))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.variable,) = _get_struct_f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.points = []
