...
"""autogenerated by genpy from robospect_msgs/State.msg. Do not edit."""
import sys
...
class State(genpy.Message):
  _md5sum = "dfca35ea56f7d6866bf502504f711dc8"
  _type = "robospect_msgs/State"
...
"""
  ...
  __slots__ = ['state','desired_freq','real_freq','state_description','control_mode']
  _slot_types = ['int32','float32','float32','string','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       state,desired_freq,real_freq,state_description,control_mode
