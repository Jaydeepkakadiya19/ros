...
class SetElevatorActionResult(genpy.Message):
  _md5sum = "6ee26b6df4f4d156c6b8e7c62865c546"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.result.result))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.status.state = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.result.status.position = str[start:end].decode('utf-8')
      else:
