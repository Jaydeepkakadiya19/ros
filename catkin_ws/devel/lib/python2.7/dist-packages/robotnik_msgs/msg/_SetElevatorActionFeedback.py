...
"""autogenerated by genpy from robotnik_msgs/SetElevatorActionFeedback.msg. Do not edit."""
import sys
...
class SetElevatorActionFeedback(genpy.Message):
  _md5sum = "f5744a577105abc7cbf3dfdce13037d5"
  _type = "robotnik_msgs/SetElevatorActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','robotnik_msgs/SetElevatorFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetElevatorActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = robotnik_msgs.msg.SetElevatorFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = robotnik_msgs.msg.SetElevatorFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.feedback.status.state
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.feedback.status.position
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.status.state = str[start:end].decode('utf-8')
      else:
        self.feedback.status.state = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.feedback.status.position = str[start:end].decode('utf-8')
      else:
        self.feedback.status.position = str[start:end]
      return self
