...
class SetElevatorAction(genpy.Message):
  _md5sum = "a239c1d232c11052aae10003929f5e20"
...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_result.result.status.state = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_result.result.status.position = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_feedback.feedback.status.state = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.action_feedback.feedback.status.position = str[start:end].decode('utf-8')
      else:
