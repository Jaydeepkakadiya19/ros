...
struct alarmsmonitor_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::robotnik_msgs::alarmmonitor_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::robotnik_msgs::alarmmonitor_<ContainerAllocator> >::other >  _alarms_type;
  _alarms_type alarms;
