...
if("FALSE" STREQUAL "TRUE")
  set(check_odometry_SOURCE_PREFIX /home/jaydeep/catkin_ws/src/check_odometry)
  set(check_odometry_DEVEL_PREFIX /home/jaydeep/catkin_ws/devel)
  ...
  set(check_odometry_INSTALL_PREFIX /home/jaydeep/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'check_odometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT check_odometry_NUM_DUMMY_TARGETS)
      set(check_odometry_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::check_odometry::wrapped-linker-option${check_odometry_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR check_odometry_NUM_DUMMY_TARGETS "${check_odometry_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::check_odometry::wrapped-linker-option${check_odometry_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND check_odometry_LIBRARIES "${interface_target_name}")
